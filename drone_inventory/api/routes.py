...
from drone_inventory.models import db
from drone_inventory.models import User
from drone_inventory.models import Drone
from drone_inventory.models import drone_schema
from drone_inventory.models import drones_schema
...
@api.route('/drones/<id>', methods = ['GET']) # <--- looking for a specific id within drones, id is user supplied
@token_required
